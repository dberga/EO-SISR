...
dict_datasets = {
    'xview_short':{
        'data_path': f"./Data/xview_short", #10 images, 256x256
        'images_folder': "images_crops",
        'src_format': 'tif'
    },
    'inria-aid_short-test':{
        'data_path': f"./Data/inria-aid_short-test", #10 images, 256x256
        'images_folder': "test_images_crops",
        'src_format': 'tif'
    },
    'inria-aid_short-val':{
        'data_path': f"./Data/inria-aid_short-val", #10 images, 256x256
        'images_folder': "val_images_crops",
        'src_format': 'tif'
    },
    'inria-aid_short-train':{
        'data_path': f"./Data/inria-aid_short-train", #10 images, 256x256
        'images_folder': "train_images_crops",
        'src_format': 'tif'
    },
    'deepglobe_short':{
        'data_path': f"./Data/deepglobe_short", #10 images, 256x256
        'images_folder': "images_crops",
        'src_format': 'jpg'
    },
    'ucmerced_short':{
        'data_path': f"./Data/ucmerced_short",  #10 images, 256x256
        'images_folder': "images",
        'src_format': 'tif'
    },
    'test-ds': {
        'data_path': f"./Data/test-ds", #380 images, 232x232
        'images_folder': "test",
        'src_format': 'tif'
    }
}
...
data_path = f"./Data/DeepGlobe/scratch/pau/SATE00_SUPE00/DATA_SOURCES"
images_folder = "DeepGlobe" # images too big
src_format = 'jpg'
data_path = f"./Data/DeepGlobe/scratch/pau/SATE00_SUPE00/DATA_SOURCES"
images_folder = "hr_images" # images too big
src_format = 'tif'
data_path = f"./Data/UCMerced_LandUse/Images"
images_folder = "agricultural" # and more categories # 256x256
src_format = 'tif'
data_path = f"./Data/kaggle-shipsnet/shipsnet"
images_folder = "shipsnet" #80x80
src_format = 'png'
'''
...
parser.add_argument('--dataset',type=str, default='test-ds')
args=parser.parse_args()
data_path = dict_datasets[args.dataset]['data_path']
images_folder = dict_datasets[args.dataset]['images_folder']
src_format = dict_datasets[args.dataset]['src_format']

#notebook
'''
dataset = 'test-ds'
data_path = dict_datasets[dataset]['data_path']
images_folder = dict_datasets[dataset]['images_folder']
src_format = dict_datasets[args.dataset]['src_format']
'''
...
#Output
plots_folder = "plots_qmrloss/"+experiment_name+"/"
comparison_folder = "comparison_qmrloss/"+experiment_name+"/"
results_folder = "results_qmrloss/"+experiment_name+"/"

#DS wrapper is the class that encapsulate a dataset
ds_wrapper = DSWrapper(data_path=data_path,data_input=images_path)
...
if plot_sne:
    plotSNE(database_name, images_path, (80,80), 6e3, True, savefig, plots_folder)
...
ds_modifiers_list = [
    DSModifierFake(name="Original",images_dir=images_path,src_ext = src_format,dst_ext=src_format),
    DSModifierMSRN( params={
        ...
        #'model':"MSRN/MSRN_1to05/model_epoch_1500.pth",
        #'model': "checkpoint_vanilla_200epoch_crops128_bsize32_lr0001model_epoch_200.pth",
        #'model': "checkpoint_vanilla_200epoch_crops256_bsize16_lr0001model_epoch_200.pth",
        #'model': "checkpoint_vanilla_200epoch_crops128_bsize32_lr0001_scale4model_epoch_200.pth",
        #'model': "checkpoint_vanilla_200epoch_crops256_bsize16_lr0001_scale4model_epoch_200.pth",
        #'model': "checkpoint_vanilla_200epoch_crops128_bsize32_lr0001_scale4_addnoisemodel_epoch_200.pth",
        #'model': "checkpoint_vanilla_200epoch_crops256_bsize16_lr0001_scale4_addnoisemodel_epoch_200.pth",
        'compress': False,
        'add_noise': None,
        'zoom': settings_zoom,
        'blur': settings_lr_blur,
    ...
    DSModifierMSRN( params={
        ...
        #'model':"MSRN_nonoise/MSRN_1to05/model_epoch_1500.pth",
        #'model':"MSRN/MSRN_1to05/model_epoch_1500.pth",
        'model': "checkpoint_sigma_L1loss_200epoch_crops256_bsize16_lr0001_factor010_clampmodel_epoch_200.pth",
        'compress': False,
        'add_noise': None,
        'zoom': settings_zoom,
        'blur': settings_lr_blur,
    ...
    DSModifierMSRN( params={
        ...
        #'model':"MSRN_nonoise/MSRN_1to05/model_epoch_1500.pth",
        #'model':"MSRN/MSRN_1to05/model_epoch_1500.pth",
        'model': "checkpoint_scale_L1loss_200epoch_crops256_bsize16_lr0001_factor010_clampmodel_epoch_200.pth",
        'compress': False,
        'add_noise': None,
        'zoom': settings_zoom,
        'blur': settings_lr_blur,
    ...
    DSModifierMSRN( params={
        ...
        #'model':"MSRN_nonoise/MSRN_1to05/model_epoch_1500.pth",
        #'model':"MSRN/MSRN_1to05/model_epoch_1500.pth",
        'model': "checkpoint_sharpness_L1loss_200epoch_crops256_bsize16_lr0001_factor010_clampmodel_epoch_200.pth",
        'compress': False,
        'add_noise': None,
        'zoom': settings_zoom,
        'blur': settings_lr_blur,
    ...
    DSModifierMSRN( params={
        ...
        #'model':"MSRN_nonoise/MSRN_1to05/model_epoch_1500.pth",
        #'model':"MSRN/MSRN_1to05/model_epoch_1500.pth",
        'model': "checkpoint_rer_L1loss_200epoch_crops256_bsize16_lr0001_factor010_clampmodel_epoch_200.pth",
        'compress': False,
        'add_noise': None,
        'zoom': settings_zoom,
        'blur': settings_lr_blur,
    ...
    DSModifierMSRN( params={
        ...
        #'model':"MSRN_nonoise/MSRN_1to05/model_epoch_1500.pth",
        #'model':"MSRN/MSRN_1to05/model_epoch_1500.pth",
        'model': "checkpoint_snr_L1loss_200epoch_crops256_bsize16_lr0001_factor010_clampmodel_epoch_200.pth",
        'compress': False,
        'add_noise': None,
        'zoom': settings_zoom,
        'blur': settings_lr_blur,
...
#DSModifierMSRN( params={
        ...
        #'model':"MSRN_nonoise/MSRN_1to05/model_epoch_1500.pth",
        #'model':"MSRN/MSRN_1to05/model_epoch_1500.pth",
    #    'model': "checkpoint_sigma_L1loss_200epoch_crops512_bsize4_lr0001_factor010_clampmodel_epoch_200.pth",
    #    'compress': False,
    #    'add_noise': None,
    #    'zoom': settings_zoom,
    #    'blur': settings_lr_blur,
    ...
    #DSModifierMSRN( params={
        ...
        #'model':"MSRN_nonoise/MSRN_1to05/model_epoch_1500.pth",
        #'model':"MSRN/MSRN_1to05/model_epoch_1500.pth",
    #    'model': "checkpoint_rer_L1loss_200epoch_crops512_bsize4_lr0001_factor010_clampmodel_epoch_200.pth",
    #    'compress': False,
    #    'add_noise': None,
    #    'zoom': settings_zoom,
    #    'blur': settings_lr_blur,
    ...
    #DSModifierMSRN( params={
        ...
        #'model':"MSRN_nonoise/MSRN_1to05/model_epoch_1500.pth",
        #'model':"MSRN/MSRN_1to05/model_epoch_1500.pth",
    #    'model': "checkpoint_snr_L1loss_200epoch_crops512_bsize4_lr0001_factor010_clampmodel_epoch_200.pth",
    #    'compress': False,
    #    'add_noise': None,
    #    'zoom': settings_zoom,
    #    'blur': settings_lr_blur,
